...
//         $this->imageW || $this->imageW = $this->length*$this->fontSize*1.5 + $this->length*$this->fontSize/2; 
        $this->imageW || $this->imageW = $this->length*$this->fontSize*1.2+$this->fontSize;
        // 图片高(px)
//         $this->imageH || $this->imageH = $this->fontSize * 2.5;
        $this->imageH || $this->imageH = $this->fontSize * 2.0;
...
//                 $codeNX  = $i*$this->fontSize*1.2+mt_rand(0, $this->fontSize*0.2)+$this->fontSize/2;
...
//                 imagettftext($this->_image, $this->fontSize, mt_rand(-30, 30), $codeNX, $this->fontSize*1.3, $this->_color, $this->fontttf, $code[$i]);
                imagettftext($this->_image, $this->fontSize, 0, $i*$this->fontSize*1.2+$this->fontSize/1.5, $this->fontSize*1.5, $this->_color, $ttfPath.'6.ttf', strtoupper($code[$i]));
            }
        }
